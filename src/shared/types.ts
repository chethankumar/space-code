...
export type NaEditorApi = {
  ...
  createFile: (project: ProjectRecord, dirPath: string, fileName: string) => Promise<void>;
  createDirectory: (project: ProjectRecord, dirPath: string, dirName: string) => Promise<void>;
  deletePath: (project: ProjectRecord, path: string, isDirectory: boolean) => Promise<void>;
  renamePath: (project: ProjectRecord, oldPath: string, newPath: string) => Promise<void>;
  revealInFinder: (project: ProjectRecord, path: string) => Promise<void>;
  showContextMenu: (payload: { filePath: string; fileName: string; isDirectory: boolean; dirPath: string; projectId: string; projectRootPath: string }) => Promise<{ action: string; [key: string]: unknown }>;
  showProjectContextMenu: (payload: { projectId: string; projectName: string }) => Promise<{ action: string; [key: string]: unknown }>;
